...
<head>
    ...
    <title>Create Custom Role - {{ $crew->name }}</title>
        ...
        <header class="bg-purple-600 text-white p-4">
            <div class="container mx-auto flex justify-between items-center">
                <div>
                    ...
                    <p class="text-purple-200">Create Custom Role</p>
                </div>
        ...
        <main class="container mx-auto p-4">
            <div class="max-w-2xl mx-auto">
                <div class="bg-white rounded-lg shadow-lg p-6">
                    <h2 class="text-xl font-semibold mb-6">Create Custom Role for {{ $crew->name }}</h2>

                    <form action="{{ route('crews.store-role', $crew) }}" method="POST" class="space-y-6">
                        @csrf
                        ...
                        <div>
                            ...
                            <input type="text" id="name" name="name" value="{{ old('name') }}" required
                                ...
                                placeholder="e.g. Lead Photographer, Content Manager, Senior Stylist">
                            @error('name')
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500 mt-1">This color will be used to display the role in the interface</p>
                            @error('color')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                            ...
                            <div class="space-y-3 bg-gray-50 p-4 rounded-lg">
                                ...
                                <label class="flex items-center">
                                    ...
                                    <input type="checkbox" name="permissions[can_view_items]" value="1" 
                                        {{ old('permissions.can_view_items', $defaultPermissions['can_view_items']) ? 'checked' : '' }}
                                        class="mr-3">
                                    <div>
                                ...
                                <label class="flex items-center">
                                    ...
                                    <input type="checkbox" name="permissions[can_upload]" value="1" 
                                        {{ old('permissions.can_upload', $defaultPermissions['can_upload']) ? 'checked' : '' }}
                                        class="mr-3">
                                    <div>
                                ...
                                <label class="flex items-center">
                                    ...
                                    <input type="checkbox" name="permissions[can_edit]" value="1" 
                                        {{ old('permissions.can_edit', $defaultPermissions['can_edit']) ? 'checked' : '' }}
                                        class="mr-3">
                                    <div>
                                ...
                                <label class="flex items-center">
                                    ...
                                    <input type="checkbox" name="permissions[can_delete]" value="1" 
                                        {{ old('permissions.can_delete', $defaultPermissions['can_delete']) ? 'checked' : '' }}
                                        class="mr-3">
                                    <div>
                                        <span class="font-medium">🗑️ Delete Items</span>
                                        <p class="text-sm text-gray-600">Can permanently remove items (use carefully!)</p>
                                    </div>
                                </label>
                                ...
                                <label class="flex items-center">
                                    ...
                                    <input type="checkbox" name="permissions[can_manage_members]" value="1" 
                                        {{ old('permissions.can_manage_members', $defaultPermissions['can_manage_members']) ? 'checked' : '' }}
                                        class="mr-3">
                                    <div>
                                        <span class="font-medium">👥 Manage Members</span>
                                        <p class="text-sm text-gray-600">Can change other members' roles and remove members</p>
                                    </div>
                                </label>
                            </div>
                            @error('permissions')
                        ...
                        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                            <h3 class="font-semibold text-blue-800 mb-2">💡 Example Role Setups</h3>
                            <div class="text-sm space-y-2">
                                <div class="flex justify-between">
                                    <span class="font-medium">📸 Photographer:</span>
                                    <span class="text-blue-600">View + Upload + Edit</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="font-medium">👔 Manager:</span>
                                    <span class="text-blue-600">View + Upload + Edit + Manage Members</span>
                                </div>
                                <div class="flex justify-between">
                                    <span class="font-medium">✨ Stylist:</span>
                                    <span class="text-blue-600">View + Upload</span>
                                </div>
                            </div>
                        </div>
